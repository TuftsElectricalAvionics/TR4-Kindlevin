...
const gpio_num_t PIN_NUM_MOSI = (gpio_num_t)0; // TODO!
const gpio_num_t PIN_NUM_MISO = (gpio_num_t)0; // TODO!
const gpio_num_t PIN_NUM_CLK = (gpio_num_t)0; // TODO!
const gpio_num_t PIN_NUM_CS = (gpio_num_t)0; // TODO!
