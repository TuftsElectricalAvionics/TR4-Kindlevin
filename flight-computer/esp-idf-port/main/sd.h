...
namespace seds {
    ...
    public:
        ...
        */
        ...
        Expected<TaskHandle_t> create_log_task(const char* path, uint8_t* buffer, std::atomic<size_t> *max_idx, std::atomic<size_t> *insert_idx, size_t min_size, std::atomic<bool> *sd_sem);
